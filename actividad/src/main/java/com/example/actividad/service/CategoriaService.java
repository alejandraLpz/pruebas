...
public class CategoriaService {
	...
	public Optional<categoria> ListaCID(String idc){
		return repositorioC.findAllById(idc);
	}
	
	public categoria editarCategoria(String idc, String det) {
		Optional<categoria> buscaP = this.repositorioC.findAllById(idc);
		if(buscaP.isPresent()) {
	...
	public boolean eliminaCategoria(String idc) {
		try {
