...
public class CategoriaController {
	...
	@GetMapping("/{id}")
	public Optional<categoria> buscaID(@PathVariable String idc){
		return servicioC.ListaCID(idc);
	}
	
	@PutMapping("/{id}")
	public categoria editarP(@PathVariable String idc, @RequestBody String det) {
		return servicioC.editarCategoria(idc, det);
	}
	
	@DeleteMapping("/{id}")
	public String eliminaP(@PathVariable String id) {
